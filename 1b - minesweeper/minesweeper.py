...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for sentence in self.knowledge:
            ...
            if sentence.count > 0 and len(known_safes) > 0:
                new_cells = sentence.cells - known_safes
                new_count = sentence.count - len(known_safes)
    ...
    def get_neighbors(self, cell):
        """
        Returns the valid neighbors of a given cell.
        """
        i, j = cell
        neighbors = set()
        for x in [-1, 0, 1]:
    ...
    def remove_empty_sentences(self):
        """
        Removes empty sentences from the AI's knowledge base.
        """
